...
public class NetworkUtils {
    ...
    private static final String API_KEY = "241144acc6c1043bb7f6d50cd60bab7b";
    ...
    //класс, который помогает загружать данные и при смене ориентации или локализации не потерять данные
